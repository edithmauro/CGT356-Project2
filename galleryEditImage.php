...
<body>
    ...
    <!--<img style = "width: 100%;" src = "header/PHOTOS.jpg" alt = "header">  when header is in it is wonky-->
        ...
        <form id = "form0" name = "form0" method = "post" action = galleryEditImageDo.php>
        <fieldset>
        ...
        <ul>
            ...
            <button class = "button-default" id="backButton" name="backButton" type="submit" formaction="gallery.php">< Back</button>
 
            <button class = "button-default" id="updateButton" name="galleryEditImageDo" type="submit" formaction="galleryEditImageDo.php">Update</button>
